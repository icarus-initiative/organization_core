...
## Org Repository: Squadrons.md Template
...
- [FILL ME IN] Expedition takeoff on [FILL ME IN]
  - [ ] Pitstop 1 on [FILL ME IN]
  - [ ] Pitstop 2 on [FILL ME IN]
  - [ ] Pitstop 3 on [FILL ME IN]
  - [ ] Pitstop 4 on [FILL ME IN]
  - [ ] Pitstop 5 on [FILL ME IN]
- [FILL ME IN] Expedition targeted landing on [FILL ME IN]
- [FILL ME IN] Expedition actual landing on [FILL ME IN]
...
## Squadron Repository: Meeting Notes

```
# Meeting 7

- Purpose: IE Pitstop 5
- Date: IE Sunday, October 3rd, 2021 at 2PM CST (UTC -5)
- Location: IE The Icarus Initiative Discord at Cafe voice channel.
